...
class ChannelManager: NSObject {
    ...
    var defaultChannelUniqueName = "CH10612a02f71c47899e95b081afbabc85"
//    var defaultChannelUniqueName = "CH10612a02f71c47899e95b081afbabc85"
    ...
    func joinGeneralChatRoomWithCompletion(completion: @escaping (Bool) -> Void) {
        ...
        let uniqueName = ChannelManager.sharedManager.defaultChannelUniqueName
    ...
    func setGeneralChatRoomUniqueNameWithCompletion(completion:@escaping (Bool) -> Void) {
        generalChannel.setUniqueName(ChannelManager.sharedManager.defaultChannelUniqueName) { result in
            completion((result.isSuccessful()))
        }
    }
